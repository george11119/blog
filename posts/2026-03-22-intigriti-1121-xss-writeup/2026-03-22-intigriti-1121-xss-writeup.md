...
<!-- I have lots of {{}} in the page. I want to treat them literally using v-pre -->
::: v-pre
...
![challenge page](./assets/intigriti-1121-challenge-page.jpg)
...
![Conditional breakpoints](./assets/intigriti-1121-conditional-breakpoints.jpg)
...
![Abusing CSP to deactivate first script tag](./assets/intigriti-1121-abusing-csp.jpg)
...
![bypass version truncation](./assets/intigriti-1121-bypass-version-truncate.jpg)
...
![image](./assets/intigriti-1121-challenge-archive-page.jpg)
...
![ctrl fing for canary value](./assets/intigriti-1121-ctrl-f-for-canary-value.jpg)
...
![Failed CSTI attempt](./assets/intigriti-1121-failed-csti-attempt.jpg)
...
![backend sanitizing v](./assets/intigriti-1121-backend-sanitizing-v.jpg)
...
![Abusing CSP again](./assets/intigriti-1121-abusing-csp-2.jpg)
...
![Solved](./assets/intigriti-1121-solved.jpg)
