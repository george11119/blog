...
- before Vue is initialized: 
  ![before vue is loaded](/assets/images/CSTI-before-vue-loaded.jpg)

- after Vue is initialized: 
  ![after vue is loaded](/assets/images/CSTI-after-vue-loaded.jpg)
...
![vue with user input being inserted](/assets/images/CSTI-vue-with-user-input.jpg)
...
![CSTI example](/assets/images/CSTI-CSTI.jpg)
...
![CSTI with alert example](/assets/images/CSTI-alert.jpg)
